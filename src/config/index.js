...
export const config = {
  ...
  databaseUri: process.env.MONGODB_URI || process.env.DATABASE_URL || 'mongodb://localhost:27017/primetrade_api',
  jwt: {
  ...
  cors: {
    origin: process.env.CORS_ORIGIN || ['http://localhost:5173', 'https://yashjadhav1595-projects.github.io']
  }
};
